...
/*         Class.forName("org.sqlite.JDBC");
        conn = DriverManager.getConnection("jdbc:sqlite:C:\\Tomcat 9.0\\webapps\\edu\\Local_Edu.db3"); 
    ...
    */
        ...
        String combo = request.getParameter("rSearch");
        ...
        {
        	SQL = "SELECT * FROM EMPLOYEES WHERE EMPL_ID like '%" +name + "%'";
        }else if(combo.equals("NAME")==true)
        {
